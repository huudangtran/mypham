	...
	<div id="breadcrumb">
		<div class="container">
			...
			@foreach($thuonghieu as $value)
				@foreach($mp_theothuonghieu as $mptl)
					@if($value->id==$mptl->thuonghieu_id)
						<li><a href="{{route('home')}}">Home</a></li>
						<li class="active">{{$value->tenthuonghieu}}</li>
					@endif
					@break
				@endforeach
			@endforeach
					...
					<div class="aside">
						...
						<div class="product product-widget">
							<div class="product-thumb">
								<img src="public/shop/img/thumb-product01.jpg" alt="">
							</div>
				...
				<div id="main" class="col-md-9">
					...
					<div id="store">
						...
						<div class="row">
							...
							@foreach($mp_theothuonghieu as $value)
							<!-- Product Single -->
					...
					<div class="store-filter clearfix">
						...
						<div class="pull-right">
							...
							<ul class="store-pages">
								<li><span class="text-uppercase">Page:</span></li>
								<li class="active">{{$mp_theothuonghieu->links()}}</li>
